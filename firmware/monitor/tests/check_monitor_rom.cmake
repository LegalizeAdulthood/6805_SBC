...
require_vector("timer-from-wait" "${VECTOR_TIMER_WAIT}" "tmr_wt_disp")
require_vector("timer" "${VECTOR_TIMER}" "tmr_disp")
require_vector("external" "${VECTOR_EXTERNAL}" "ext_disp")
require_vector("SWI" "${VECTOR_SWI}" "swi")
require_vector("reset" "${VECTOR_RESET}" "reset")
require_symbol_in_rom("rom_end")

math(EXPR fill_start "0x${SYM_rom_end}")
